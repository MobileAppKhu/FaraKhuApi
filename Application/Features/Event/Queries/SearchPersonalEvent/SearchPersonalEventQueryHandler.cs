...
{
    public class SearchPersonalEventQueryHandler : IRequestHandler<SearchPersonalEventQuery, SearchPersonalEventViewModel>
    {
        ...
        public SearchPersonalEventQueryHandler(IMapper mapper, UserManager<BaseUser> userManager,
        ...
        public async Task<SearchPersonalEventViewModel> Handle(SearchPersonalEventQuery request, CancellationToken cancellationToken)
        {
            ...
            return new SearchPersonalEventViewModel
            {
