...
{
    public class AddAnswerCommandHandler : IRequestHandler<AddAnswerCommand, AddAnswerViewModel>
    {
        ...
        public AddAnswerCommandHandler( IStringLocalizer<SharedResource> localizer,
        ...
        public async Task<AddAnswerViewModel> Handle(AddAnswerCommand request, CancellationToken cancellationToken)
        {
